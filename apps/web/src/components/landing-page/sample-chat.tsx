...
export const SampleChat = () => {
  return (
    <>
      <div className="overflow-hidden border-t px-2 py-6 sm:p-6 md:border-0 dark:bg-transparent">
        <div className="relative overflow-visible rounded-xl border bg-gray-50 p-1 shadow-sm ring-muted ">
          <div aria-hidden className="rounded-xl border bg-white p-4 dark:bg-gray-950">
