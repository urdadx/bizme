        ...
        <DialogContent>
          <form className="space-y-5" onSubmit={handleUpdateRole}>
            <DialogHeader>
              ...
              <DialogDescription>
                Update {editingMember?.user.name}'s role in {organization.name}.
              </DialogDescription>
            </DialogHeader>
            <RadioGroup
              value={editRole}
              onValueChange={(value) => setEditRole(value as InviteRole)}
            ...
            <DialogFooter>
              <Button type="submit" disabled={isUpdatingRole} className="min-w-28">
                {isUpdatingRole ? <LoadingDots /> : "Save role"}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
            ...
            <TableRow key={member.id} className="w-full">
              <TableCell>
                <div className="flex items-center gap-3">
                  <div>
                    ...
                    <span className="mt-0.5 text-muted-foreground text-xs">{member.role}</span>
                  </div>
                </div>
              </TableCell>
              ...
              <TableCell>
                <div className="flex items-center gap-2">
                  <div className={cn("h-2 w-2 rounded-full", "bg-green-500")}></div>
                ...
                <Popover>
                  ...
                  <PopoverContent align="end" className="w-40 p-1">
                    <div className="flex flex-col gap-1">
                      ...
                      >
                        <TrashBinLinear className="mr-2 h-3.5 w-3.5" color="currentColor" />
                        Remove member
                      </Button>
                    </div>
                  </PopoverContent>
