...
type DeployInstructionType = "widget" | "frameworks" | "wordpress" | "agent";
...
export const DeployAgentDialog = () => {
  ...
  const [instructionType, setInstructionType] =
    useState<DeployInstructionType>("frameworks");
  ...
  const NavButtons = (
    ...
    >
      ...
      <button
        ...
        className={getNavButtonClassName("agent")}
      >
        <div className={getNavIndicatorClassName("agent")}></div>
        <div className="flex h-4 w-4 shrink-0 items-center justify-center text-red-600">
          <RobotIcon className="size-5" />
        </div>
        <span className="text-sm font-medium whitespace-nowrap">AI Agent</span>
      </button>
    </div>
  );
          ...
          <div className="flex w-75 shrink-0 flex-col px-8 py-10">
            <div className="mb-9">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Install Bizme comments on your site and start collecting
                feedback today.
              </p>
            </div>
