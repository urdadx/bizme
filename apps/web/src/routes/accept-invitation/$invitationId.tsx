			...
			<Card className="w-full max-w-md">
				...
				<CardContent className="space-y-4">
					{isPending || isInvitationPending ? (
						...
						<>
							<p className="text-sm text-muted-foreground">
								This invitation was sent to {invitation.email}. You
								are signed in as {session?.user.email}.
							</p>
							<Button
								className="w-full"
								onClick={handleSignInWithInvitedEmail}>
						...
						<>
							<p className="text-sm text-muted-foreground">
								You are signed in as {session.user.email}. Continue
